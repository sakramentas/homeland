...
They are not required for linting. You should see the linter output right in your terminal as well as the browser console. However, if you prefer the lint customers to appear right in your editor, there are some extra steps you can do.
