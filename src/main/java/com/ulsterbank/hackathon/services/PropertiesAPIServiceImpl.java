...
public class PropertiesAPIServiceImpl implements PropertiesAPIService {
    ...
    public PropertiesAPIServiceImpl() {
        ...
        property1.setPrice(new BigDecimal(285000));
        ...
        property2.setPrice(new BigDecimal(295000));
        ...
        property3.setPrice(new BigDecimal(325000));
        ...
        property4.setPrice(new BigDecimal(220000));
        ...
        property5.setPrice(new BigDecimal(280000));
        ...
        property7.setPrice(new BigDecimal(350000));
